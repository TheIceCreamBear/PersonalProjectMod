...
public class BlockTEOreCrusher extends BlockContainer {
	...
	public BlockTEOreCrusher() {
		super(Material.IRON);
		this.setUnlocalizedName(EnumBlocks.TE_ORE_CRUSHER.getUnlocalizedName());
		this.setRegistryName(EnumBlocks.TE_ORE_CRUSHER.getRegistryName());
