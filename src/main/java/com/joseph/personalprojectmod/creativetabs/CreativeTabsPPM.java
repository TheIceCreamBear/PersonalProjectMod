...
public class CreativeTabsPPM {
	public static final CreativeTabs PPM_ITEMS_TAB = new CreativeTabs(Refrence.MOD_ID + ".items") {
		@Override
		public ItemStack getTabIconItem() {
			return new ItemStack(ModItems.blueStoneIngot);
		}
	};
	public static final CreativeTabs PPM_TOOLS_TAB = new CreativeTabs(Refrence.MOD_ID + ".tools") {
		@Override
		public ItemStack getTabIconItem() {
			return new ItemStack(ModItems.blueStonePickaxe);
		}
	};
	public static final CreativeTabs PPM_FOOD_TAB = new CreativeTabs(Refrence.MOD_ID + ".food") {
		@Override
		public ItemStack getTabIconItem() {
